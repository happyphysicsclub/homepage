...
export const Common = ({ color }: { color?: string }) => <>{color && <color attach='background' args={[color]} />}</>
...
const Scene = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <Canvas ref={canvasRef} camera={{ fov: 30, near: 0.1, far: 1000, position: [5, 5, 5] }} shadows>
